...
const aiGreetings = [
  'Привет! Я ScreenMe — твой AI-помощник. Готов помочь тебе учиться и развиваться. О чём поговорим?',
          ...
          <div className="border-b border-gray-200 px-5 py-4 bg-gradient-to-r from-indigo-50 to-blue-50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-600 mt-0.5">ScreenMe Assistant</p>
              </div>
