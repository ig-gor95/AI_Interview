...
Сгенерируй следующее:

1. **5-7 вопросов для скрининг-собеседования** - вопросы для оценки базовых компетенций, опыта и мотивации кандидата. Для каждого вопроса добавь 2-3 уточняющих подвопроса, которые AI может задать для более глубокого понимания.

2. **3-5 обязательных требований (Must Have)** - критичные требования к кандидату, без которых он не подходит на позицию. Например: "Опыт работы в сфере от 2 лет", "Готовность к работе по сменному графику", "Проживание в городе N".

3. **3-5 желательных требований (Nice to Have)** - дополнительные плюсы, которые было бы хорошо иметь, но не критичны. Например: "Знание английского языка", "Опыт работы с CRM", "Высшее образование".

4. **Сценарий моделирования реальной рабочей ситуации** - стрессовая ситуация с клиентом/посетителем, которую AI будет симулировать в конце интервью для оценки реакции кандидата.

ВАЖНО: Вопросы должны быть подходящими именно для первичного отбора (скрининга), а не для глубокого технического интервью. Фокус на коммуникации, мотивации, базовых навыках и стрессоустойчивости.
