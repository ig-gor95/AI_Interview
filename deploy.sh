...
echo "  • Test button opens interview in new window"
echo "  • Multi-use QR codes for interview access"
echo "  • Copy link button with 'Скопировано!' notification"
echo "  • Real API integration (interviews, authentication)"
echo "  • Backend support for reusable links"
...
if [ "$CONTAINERS_UP" -eq "$CONTAINERS_TOTAL" ] && [ "$CONTAINERS_TOTAL" -gt 0 ]; then
    ...
    echo "  ✓ Test button opens in new window"
    echo "  ✓ Multi-use QR codes"
    echo "  ✓ Copy link with 'Скопировано!' notification"
