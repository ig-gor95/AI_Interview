          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="px-3 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
              >
                {t.nav.forCandidates}
              </button>
              <button
      ...
      <section className="py-20 px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Mass Recruitment Card */}
            <div className="group relative bg-white rounded-3xl p-8 border-2 border-gray-200 hover:border-blue-400 hover:shadow-2xl transition-all duration-300">
              <div className="absolute -top-4 -right-4 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-all duration-300" />
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  {t.choice.massCard.subtitle}
                </h3>
                
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.massCard.feature1}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.massCard.feature2}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.massCard.feature3}</span>
                  </li>
                </ul>
                
                <div className="mb-6">
                  <div className="text-3xl font-bold text-gray-900">{t.choice.massCard.price}</div>
                </div>
                
                <button 
                  onClick={() => onNavigate('login-organizer')}
                  className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium flex items-center justify-center gap-2"
                >
            ...
            {/* IT Recruitment Card */}
            <div className="group relative bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-purple-300 hover:border-purple-500 hover:shadow-2xl transition-all duration-300">
              <div className="absolute -top-4 -right-4 w-32 h-32 bg-purple-500/20 rounded-full blur-2xl group-hover:bg-purple-500/30 transition-all duration-300" />
              <div className="absolute top-4 right-4 px-3 py-1.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold rounded-full shadow-lg">
                PREMIUM
              </div>
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  {t.choice.itCard.subtitle}
                </h3>
                
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.itCard.feature1}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.itCard.feature2}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{t.choice.itCard.feature3}</span>
                  </li>
                </ul>
                
                <div className="mb-6">
                  <div className="text-xl font-bold text-gray-900">{t.choice.itCard.price}</div>
                </div>
                
                <button 
                  onClick={() => setShowContactModal(true)}
                  className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium flex items-center justify-center gap-2"
                >
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                  <div className="lg:text-right mb-8 lg:mb-0">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                      <span className="lg:hidden text-blue-600">1. </span>{t.journey.step1Title}
                    </h3>
                    <p className="text-base sm:text-lg text-gray-600 mb-6">
                      {t.journey.step1Description}
                    </p>
                    <div className="inline-flex items-center gap-2 text-sm text-gray-500">
                      <Clock className="w-4 h-4" />
                      <span>{t.journey.step1Time}</span>
                    </div>
                  </div>
              ...
              <div className="relative">
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                  ...
                  <div className="order-1 lg:order-2 lg:text-left mb-8 lg:mb-0">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                      <span className="lg:hidden text-purple-600">2. </span>{t.journey.step2Title}
                    </h3>
                    <p className="text-lg text-gray-600 mb-6">
                      {t.journey.step2Description}
                    </p>
              ...
              <div className="relative">
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                  <div className="lg:text-right mb-8 lg:mb-0">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                      <span className="lg:hidden text-pink-600">3. </span>{t.journey.step3Title}
                    </h3>
                    <p className="text-lg text-gray-600 mb-6">
                      {t.journey.step3Description}
                    </p>
                    <div className="inline-flex items-center gap-2 text-sm text-gray-500">
              ...
              <div className="relative">
                <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                  ...
                  <div className="order-1 lg:order-2 lg:text-left mb-8 lg:mb-0">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                      <span className="lg:hidden text-green-600">4. </span>{t.journey.step4Title}
                    </h3>
                    <p className="text-lg text-gray-600 mb-6">
                      {t.journey.step4Description}
                    </p>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-4 border border-purple-200">
                      <p className="text-xs font-semibold text-gray-700 mb-3">Типы отчетов:</p>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                          <span className="text-sm text-gray-700">Авто-рейтинг (массовые позиции)</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                          <span className="text-sm text-gray-700">Тех-аудит (IT специалисты)</span>
                        </div>
                      </div>
                    </div>
                  </div>
